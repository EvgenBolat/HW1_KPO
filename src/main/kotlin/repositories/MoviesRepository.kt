...
class MoviesRepository {
    ...
    fun editMovie(sessionsRepository: SessionsRepository, ticketsRepository: TicketsRepository, movieName: String, duration: UInt): String{
        if (moviesArray != null) {
            for (movie in moviesArray!!){
                if (movie.name.lowercase(Locale.getDefault()) == movieName.lowercase(Locale.getDefault())){
    ...
    fun removeMovie(sessionsRepository: SessionsRepository, ticketsRepository: TicketsRepository, name: String) : String {
        if (moviesArray != null) {
            for (movie in moviesArray!!){
                if (movie.name.lowercase(Locale.getDefault()) == name.lowercase(Locale.getDefault())){
                    if (sessionsRepository.sessionsArray != null){
